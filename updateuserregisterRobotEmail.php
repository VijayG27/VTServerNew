...
?>
    ...
    <?php 
					if(isset($_POST['submit'])){
			            ...
			            $update_query = "Update robotemaildb SET ExpDt = '".$updateExpDt."', trialperiod = '".$updateTrail."', Status = '".$updateStatus."', Remark = '".$updateRemark."' Where SerialNo='".$serial_no."' AND CompanyName = '".$updateCmp."'";
